...
import static com.eugene.commonsdk.base.Platform.DEPENDENCY_SUPPORT_DESIGN;
...
public final class AppManager {
     ...
     * 建议在 {@link IConfigModule#injectAppLifecycle(Context, List)} 中
     * 通过 {@link IAppLifecycle#onCreate(Application)} 在 App 初始化时,使用此方法传入自定义的 {@link HandleListener}
     *
