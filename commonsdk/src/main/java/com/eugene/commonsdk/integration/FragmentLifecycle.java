...
import com.eugene.commonsdk.base.service.FragmentDelegateImpl;
...
import static com.eugene.commonsdk.base.service.IFragmentDelegateKt.FRAGMENT_DELEGATE;
...
public class FragmentLifecycle extends FragmentManager.FragmentLifecycleCallbacks {
    ...
    private IFragmentDelegate fetchFragmentDelegate(Fragment fragment) {
        if (fragment instanceof IFragment) {
            ...
            return (IFragmentDelegate) cache.get(IntelligentCache.getKeyOfKeep(FRAGMENT_DELEGATE));
        }
        return null;
    }
